...
<?php
	...
	//for question 1 								
	$sql_query_q1 = 'select ans1, count(*), sem_id, division_id, sub_id from feedback_master where ('. $search_para_str .') group by ans1 order by ans1';		
	//print $sql_query_q1;
	...
	<table>
		<tr>
			<td>Semester : <?php echo $sem_name;?> | Division : <?php echo $division_name;?></td> 						
		</tr>
		<tr>
	...
	$final_table_string_new .= get_table_string('ans10', $search_para_str, 10, $analytic_array);	
	...
	$final_table_string_new .= '</tr>';	
	$final_table_string_new .= '<tr><td align="center"><b>Avg. Rating</b></td><td colspan="11" align="center"><b>'.($rating_n_analytic_value).'/'.$total_of_rating.' = '.number_format((float)$analytic_result, 2, '.', '').'</b></td></tr>';	
